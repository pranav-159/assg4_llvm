; ModuleID = './examples/emp4.cpp'
source_filename = "./examples/emp4.cpp"
...
@_ZTV7Derived = linkonce_odr dso_local unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI7Derived to i8*), i8* bitcast (void (%class.Derived*)* @_ZN7Derived5printEv to i8*)] }, comdat, align 8
...
@_ZTV4Base = linkonce_odr dso_local unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI4Base to i8*), i8* bitcast (void (%class.Base*)* @_ZN4Base5printEv to i8*)] }, comdat, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_emp4.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  store %class.Base* %4, %class.Base** %3, align 8
  %5 = load %class.Base*, %class.Base** %3, align 8
  %6 = bitcast %class.Base* %5 to void (%class.Base*)***
  %7 = load void (%class.Base*)**, void (%class.Base*)*** %6, align 8
  %8 = getelementptr inbounds void (%class.Base*)*, void (%class.Base*)** %7, i64 0
  %9 = load void (%class.Base*)*, void (%class.Base*)** %8, align 8
  call void %9(%class.Base* %5)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN7DerivedC2Ev(%class.Derived* %0) unnamed_addr #5 comdat align 2 {
  %2 = alloca %class.Derived*, align 8
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV7Derived, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN4BaseC2Ev(%class.Base* %0) unnamed_addr #5 comdat align 2 {
...
define linkonce_odr dso_local void @_ZN7Derived5printEv(%class.Derived* %0) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.Derived*, align 8
  store %class.Derived* %0, %class.Derived** %2, align 8
  %3 = load %class.Derived*, %class.Derived** %2, align 8
  %4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0))
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZN4Base5printEv(%class.Base* %0) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.Base*, align 8
  store %class.Base* %0, %class.Base** %2, align 8
  %3 = load %class.Base*, %class.Base** %2, align 8
  %4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0))
  %5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %4, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_emp4.cpp() #0 section ".text.startup" {
